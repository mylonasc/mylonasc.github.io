...
It's difficult to model *exactly* how the structure is excited, but one does not really need to model at all how it is excited to perform the down-stream task of localization.
